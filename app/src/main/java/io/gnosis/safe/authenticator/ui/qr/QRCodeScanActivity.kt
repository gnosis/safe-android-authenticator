...
import io.gnosis.safe.authenticator.utils.CAMERA_REQUEST_CODE
import io.gnosis.safe.authenticator.utils.handlePermissionsResultRequest
import io.gnosis.safe.authenticator.utils.isPermissionGranted
import io.gnosis.safe.authenticator.utils.requestPermissions
...
class QRCodeScanActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        private const val RESULT_EXTRA = "extra.string.scan_result"
